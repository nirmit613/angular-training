...
export class BookCardsComponent {
  ...
  imageUrl = ["../../assets/cardOne.jpg", "../../assets/cardOne.jpg","../../assets/cardOne.jpg","../../assets/cardOne.jpg","../../assets/cardOne.jpg","../../assets/cardOne.jpg"];
  booksList:any[] = [
    {
    ...
    },
    {
      imageUrl: '../../assets/cardOne.jpg',
      title: 'BookTwo',
      description:'The novel was inspired by a youthful romance Fitzgerald had with socialite Ginevra King, and the riotous parties he attended on Long Island\'s North Shore in 1922. Following a move to the French Riviera, Fitzgerald completed a rough draft of the novel in 1924.'
    },
    {
      imageUrl: '../../assets/cardOne.jpg',
      title: 'BookThree',
